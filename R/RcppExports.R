...
computNeiIndex <- function(pseData, num_neighbors_foreach_word, word_neighbors) {
    .Call(`_gnSPADE_computNeiIndex`, pseData, num_neighbors_foreach_word, word_neighbors)
}
...
word_in_doc <- function(doc, word) {
    .Call(`_gnSPADE_word_in_doc`, doc, word)
}
...
calc_PGtheta_R <- function(theta_tilda, theta, num_doc, num_topics) {
    .Call(`_gnSPADE_calc_PGtheta_R`, theta_tilda, theta, num_doc, num_topics)
}
...
make_wsz_cpp <- function(docs_, info_, initialized_) {
    .Call(`_gnSPADE_make_wsz_cpp`, docs_, info_, initialized_)
}

load_wordid_neighcnt <- function(neiPath, vocab) {
    .Call(`_gnSPADE_load_wordid_neighcnt`, neiPath, vocab)
}
...
read_dfm_cpp <- function(dfm, W_read, vocab, split) {
    .Call(`_gnSPADE_read_dfm_cpp`, dfm, W_read, vocab, split)
}
...
keyATM_fit_LDA <- function(model, resume = FALSE) {
    .Call(`_gnSPADE_keyATM_fit_LDA`, model, resume)
}
